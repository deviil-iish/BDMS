        ...
        <div id="page-wrapper">
            <div class="container-fluid">
               ...
               <div class="row">
                    <div class="col-lg-12">
                        <div class="white-box">
                            <h3 class="box-title">Donor Datatable</h3>
                            ...
                            <table class="table table-striped table-bordered" id="editable-datatable">
                                ...
                                <tbody>
                                    ...
                                    require("../../AdminConnect.php");
                                        ...
                                        $sql= "SELECT Name, Blood_Group, Contact_no, LastDonationDate, CONCAT(Location, ', ', City) as Address FROM donor";
