...
<div class="row">
                    <div class="col-lg-12">
                        <div class="white-box">
                            <h3 class="box-title">Recipient Datatable</h3>
                            ...
                            <table class="table table-striped table-bordered" id="editable-datatable">
                                ...
                                <tbody>
                                    ...
                                    require("../../AdminConnect.php");
                                        ...
                                        $sql= "SELECT Name, Age, Gender, BloodGroup, ContactNo, RegistrationDate, CONCAT(Location, ', ', City) as Address FROM recipient";
