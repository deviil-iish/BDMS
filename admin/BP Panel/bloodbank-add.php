                ...
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Add Blood Bank</li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <form class="form-material form-horizontal">
                                ...
                                <div class="form-group">
                                    <label class="col-md-12" for="website">Website</span>
                                    </label>
                                    <div class="col-md-12">
                                        <input type="text" name="website" class="form-control" placeholder="Website"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12" for="location">Location</span>
                                    </label>
                                    <div class="col-md-12">
                                        <input type="text" name="location" class="form-control" placeholder="Location"> </div>
                                </div>
