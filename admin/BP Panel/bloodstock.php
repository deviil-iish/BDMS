        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Blood Stock</li>
                        </ol>
                    </div>
                </div>
                <!-- .row -->
                <div class="row">
                    <div class="col-lg-12">
                        <div class="white-box">
                            <h3 class="box-title">Blood Stock Datatable</h3>
                            ...
                            <table class="table table-striped table-bordered" id="editable-datatable">
                                ...
                                <tbody>
                                    ...
                                    require("../../AdminConnect.php");
                                        ...
                                        $sql= "SELECT Blood_bag_ID ,Blood_Group, Status, BestBefore FROM blood_stock";
                                 ...
                                 ?>
                                            <tr>
                                                ...
                                                <?php if ( $row['Status'] == "Processing"){ ?>
                                                    <button class="btn btn-block btn-danger"><?php echo $row['Status'];?></button>
                                                <?php } ?>
                                                 <?php if ( $row['Status'] == "Testing"){ ?>
                                                        <button class="btn btn-block btn-warning"><?php echo $row['Status'];?></button>
                                                <?php } ?>
                                                <?php if ( $row['Status'] == "Storage"){ ?>
                                                        <button class="btn btn-block btn-success"><?php echo $row['Status'];?></button>
                                                <?php } ?>
                                                </td>
                                                <td>
                                                    <?php echo $row['BestBefore'];?>
                                                </td>
                                            </tr>
                                            <?php
                                            } 
