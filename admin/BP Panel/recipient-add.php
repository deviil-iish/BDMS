                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <form class="form-material form-horizontal">
                                ...
                                <div class="form-group">
                                    <label class="col-md-12">Age</span>
                                    </label>
                                    <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label class="col-md-12" for="date">Registration Date</span>
                                    </label>
                                    <div class="col-md-12">
                                        <input type="text" name="date" class="form-control mydatepicker" placeholder="Today's Date"> </div>
                                </div>
