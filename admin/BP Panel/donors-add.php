                        ...
                        <div class="white-box">
                            ...
                            <form class="form-material form-horizontal">
                                <div class="form-group">
                                    <label class="col-md-12">Name</span>
                                    </label>
                                    <div class="col-md-12">
                                        <input type="text" name="dname" class="form-control" placeholder="Name"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12" for="city">City</span>
                                    </label>
                                    <div class="col-md-12">
                                        <input type="text" name="city" class="form-control" placeholder="City of Residence"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12" for="location">Address</span>
                                    </label>
                                    <div class="col-md-12">
                                        <input type="text" name="location" class="form-control" placeholder="Address"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12" for="phone">Contact No.</span>
                                    </label>
                                    <div class="col-md-12">
                                        <input type="text" name="phone" class="form-control" placeholder="Contact Phone Number"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12" for="cnic">CNIC</span>
                                    </label>
                                    <div class="col-md-12">
                                        <input type="text" name="cnic" class="form-control" placeholder="CNIC"> </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <select name="bloodgroup" class="form-control" placeholder="Select Blood Group">
                                            <option>A+</option>
                                            <option>A-</option>
                                            <option>B+</option>
                                            <option>B-</option>
                                ...
                                <div class="form-group">
                                    <label class="col-md-12" for="dob">Date of Birth</span>
                                    </label>
                                    <div class="col-md-12">
                                        <input type="text" name="dob" class="form-control mydatepicker" placeholder="Date of Birth"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12" for="ldd">Last Donation Date</span>
                                    </label>
                                    <div class="col-md-12">
                                        <input type="text" name="ldd" class="form-control mydatepicker" placeholder="Last Donation Date"> </div>
                                </div>
